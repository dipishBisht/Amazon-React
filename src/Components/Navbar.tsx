...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1350px] mx-auto overflow-x-hidden">
      <div className="relative bg-[#131921] text-white flex justify-between items-center gap-4 py-2 px-3">
        ...
        <div
          className="flex gap-5 flex-col absolute right-0 top-16 bg-[#131921] items-start w-fit h-[99vh] px-1 py-2 lg:flex-row lg:w-full lg:h-auto lg:static"
          style={navStyle}
        >
